...
SERVE_MEDIA = config('SERVE_MEDIA', default=False, cast=bool) and not USE_CLOUDINARY
...
MIDDLEWARE = [
    ...
    'apps.core.middleware.CsPrefixRedirectMiddleware',
