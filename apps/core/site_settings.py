...
class SiteSettings(models.Model):
    ...
    hours = models.CharField(_('Години роботи (CS)'), max_length=100, default='Po–Pá 10:00–21:00, So–Ne 10:00–19:00')
    hours_en = models.CharField(_('Години роботи (EN)'), max_length=100, blank=True)
    hours_ru = models.CharField(_('Години роботи (RU)'), max_length=100, blank=True)
