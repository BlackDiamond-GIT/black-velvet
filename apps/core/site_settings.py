...
class SiteSettings(models.Model):
    ...
    hours = models.CharField(_('Години роботи (CS)'), max_length=100, default='Denně od 9:00 do 5:00 ráno')
    hours_en = models.CharField(_('Години роботи (EN)'), max_length=100, blank=True, default='Daily from 9 AM to 5 AM')
    hours_ru = models.CharField(_('Години роботи (RU)'), max_length=100, blank=True, default='Ежедневно с 9:00 до 5:00 утра')
